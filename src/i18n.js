...
const STRINGS = {
  en: {
    ...
    diademStuck: 'The tarnished tiara does not so much as tremble. Some things refuse to be summoned — they must be fetched by hand, for someone who misses them.',
  ...
  az: {
    ...
    diademStuck: 'Tutqun tac yerindən tərpənmir də. Bəzi şeylər sehrlə çağırılmır — onları əllə, onlar üçün darıxan birisi üçün götürmək lazımdır.',
